...
def main():
    import argparse
    p = argparse.ArgumentParser(description='Export scheduled posts as ready-to-post packs')
    p.add_argument('--all', action='store_true', help='include already-posted/failed too')
    args = p.parse_args()
